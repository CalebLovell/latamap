...
export const Banner = () => {
	...
	return (
		<div className='absolute w-full px-2 max-w-3xl'>
			<div className='relative w-full'>
				...
				>
					<p className='text-sm leading-6'>
						...
						consider reading the disclaimer in the side menu. I am aware that left-right labels are reductive, and MUCH less meaningful before the
						20th century. That is a limitation of the project. Don&apos;t take it too seriously!
					</p>
